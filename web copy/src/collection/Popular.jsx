  ...
  if (loading) {
    return (
      <div className="py-16 px-6 theme-bg min-h-screen text-center">
        <h1 className="text-4xl font-extrabold theme-secondary mb-12">🔥 Popular Products</h1>
  ...
  return (
    <div className="py-16 px-6 theme-bg min-h-screen">
      ...
      <motion.h1
        ...
        className="text-4xl font-extrabold text-center theme-secondary mb-12"
      >
        🔥 Popular Products
      </motion.h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        {products.map((product, index) => (
          <motion.div
            ...
            className="theme-surface rounded-3xl shadow-md hover:shadow-2xl transition p-5 flex flex-col items-center cursor-pointer hover:theme-hover"
          >
