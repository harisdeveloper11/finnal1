...
const Products = () => {
  ...
  const handleUpdate = (e) => {
    ...
    axios.put(`${process.env.REACT_APP_API_URL}/api/products/${editingProduct._id}`, productData)
      .then(() => {
        ...
        {products.map(product => (
          <div key={product._id} className="bg-white p-4 rounded shadow">
            ...
            <div className="mt-2 flex gap-2">
              ...
              <button onClick={() => handleDelete(product._id)} className="bg-red-500 text-white px-3 py-1 rounded text-sm hover:bg-red-600">Delete</button>
            </div>
          </div>
        ))}
      </div>
