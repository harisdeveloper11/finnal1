...
const Latest = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/products/collection/latest`);
  ...
  if (loading) {
    return (
      <div className="py-16 px-6 theme-bg min-h-screen text-center">
        <h1 className="text-4xl font-extrabold theme-secondary mb-12">✨ Latest Products</h1>
